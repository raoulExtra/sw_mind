...
Hybrid workflow engine for managing agents with verifiable state machines. The system combines flow orchestration, agent-based planning, and independent verification in a CLI tool. It uses file-based state persistence for workflow execution and state machine management.
...
Version 2 provides the code-level implementation of the hybrid workflow engine with abstract base classes, TypeScript interfaces, and concrete implementations.
