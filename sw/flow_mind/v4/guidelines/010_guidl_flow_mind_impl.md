...
version: V00.12.00
updated: 2026-06-10
summary: 'Implementation guidelines for Flow Mind v4 hybrid flow engine.'
```
...
- **Model**: Flow state and data management classes
- **View**: CLI output formatting and display handlers
- **Controller**: Command routing and flow execution
